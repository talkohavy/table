import{r as t,j as e}from"../../main/index-C-V8LVo7.js";import{C as c}from"./CodeBlock.Cj8LsT4-.js";import{m}from"./mockData.RkXdFPAn.js";import{T as n}from"./Toggle.BGIyigl6.js";import{c as i,T as d}from"./Table.CglSOpJy.js";const u="_myTable_ytcpk_1",f={myTable:u},s=i(),p=[s.accessor("id",{header:"ID"}),s.accessor("first_name",{header:"First Name",enableMultiSort:!0}),s.accessor("last_name",{header:"Last Name",enableMultiSort:!0}),s.accessor("email",{header:"Email"}),s.accessor("gender",{header:"Gender"}),s.accessor("ip_address",{header:"IP Address",meta:{className:"flex-1"}})];function N(){const[a,r]=t.useState(!0),o=t.useMemo(()=>p.map(l=>({...l,enableSorting:a})),[a]);return e.jsxs("div",{className:"flex flex-col justify-start items-start gap-4 size-full p-10",children:[e.jsx("div",{className:"border rounded-lg flex w-full",children:e.jsx("div",{className:"flex flex-col justify-between gap-6 items-start p-6",children:e.jsxs("div",{className:"flex items-center justify-between gap-4 w-full",children:[e.jsx("h2",{className:"font-medium",children:"Sorting Enabled:"}),e.jsx(n,{isChecked:a,setIsChecked:()=>r(l=>!l)})]})})}),e.jsx("div",{className:"w-full",children:e.jsx(d,{data:m,columnDefs:o,className:f.myTable})}),e.jsx(c,{language:"typescript",className:"w-full border",code:`import { useMemo, useState } from 'react';
...
`})]})}export{N as default};
//# sourceMappingURL=../../sourcemaps/index.DF_Nh1IQ.js.map
