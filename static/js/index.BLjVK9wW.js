import{a as c,r as u,j as e,c as s}from"../../main/index-C-V8LVo7.js";import{m as t}from"./mockData.RkXdFPAn.js";import{T as l}from"./Table.CglSOpJy.js";import{C as h}from"./CodeBlock.Cj8LsT4-.js";const g="_myTable_jb3bc_1",a={myTable:g};function f(){const[o,m]=c("persistent-column-sizing",{}),[i,r]=u.useState({});return e.jsxs("div",{className:"flex flex-col justify-start items-start gap-6 size-full p-10",children:[e.jsx("h1",{className:"text-2xl font-bold",children:"Table with Persistent Column Widths"}),e.jsxs("div",{className:"w-full",children:[e.jsx("h2",{className:"text-xl mb-2",children:"With Local Storage Persistence"}),e.jsx("p",{className:"mb-4",children:"This table will remember your column widths even after page refresh using localStorage. Try resizing some columns and then refresh the page."}),e.jsx(l,{data:t,allowColumnResizing:!0,initialColumnSizing:o,onColumnSizingChange:m,className:s("persistent-columns-table",a.myTable)})]}),e.jsxs("div",{className:"w-full",children:[e.jsx("h2",{className:"text-xl mb-2",children:"Without Persistence (for comparison)"}),e.jsx("p",{className:"mb-4",children:"This table will not persist column widths after refresh."}),e.jsx(l,{data:t,allowColumnResizing:!0,className:s("non-persistent-columns-table",a.myTable)})]}),e.jsxs("div",{className:"w-full",children:[e.jsx("h2",{className:"text-xl mb-2",children:"With State Management"}),e.jsx("p",{className:"mb-4",children:"This table uses React state to manage column widths. Column widths will be preserved during this session but lost on refresh."}),e.jsx(l,{data:t,allowColumnResizing:!0,initialColumnSizing:i,onColumnSizingChange:n=>{console.log("value is:",n),r(n)},className:s("state-managed-columns-table",a.myTable)})]}),e.jsxs("div",{className:"mb-4",children:[e.jsx("h2",{className:"text-xl mb-2",children:"Current Column Sizing State"}),e.jsx("pre",{className:s("p-4 rounded border","bg-gray-100 text-black","dark:bg-gray-800 dark:text-white"),children:JSON.stringify(i,null,2)})]}),e.jsx(h,{className:"w-full border mt-4 shrink-0",language:"typescript",code:`import { useState } from 'react';
...
`})]})}export{f as default};
//# sourceMappingURL=../../sourcemaps/index.BVE2Lud7.js.map
